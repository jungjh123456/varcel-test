...
const CostPayPrepending = () => {
  ...
  return (
    <CostPayPrependingWrap>
      <MainHeader applied message={"체험수업권 결제 페이지"} white />
      <div className="container">
        <div className="img_wrap">
          <div>
            <h2>똑똑쌤 홈티칭</h2>
            <div className="text-wrap">
              <span>{history.query.Classtype}</span>
            </div>
        ...
        <div className="study_info">
          ...
          <div>
            ...
            <div>
              <span>프로그램 유형</span>
              <span>{history.query.program}</span>
            </div>
            <div>
              <span>세부 프로그램</span>
              <span>{history.query.sub_program}</span>
            </div>
          </div>
        </div>
        ...
        <div ref={scoll2Ref} className="notice">
          ...
          <div className="two">
            <span>1</span>
            <div>
              <span>체험수업 일정 및 선생님 배정</span>
              <div>
                <span>체험수업 진행을 위한 일정조율 및 선생님 배정까지는 지역 별로 대기 기간의 편차가 있으며, 결제가 완료되면 별도의 알림메세지를 통해 평균 예상대기 기간이 안내됩니다.</span>
              </div>
              <div>
                <span>
                  체험수업 일정은 고객이 희망하는 스케쥴 범위 내에서 일정이 가능한 선생님 중 배정되며, 정규수업 등록 시 체험수업과 같은 요일 및 시간대 진행을 원칙으로 합니다 (불가 시, 사전 조율 필요)
                </span>
              </div>
              <div>
                <span>고객이 정규수업을 등록할 경우엔 체험수업을 담당하는 선생님은 정규수업까지 진행하게 되며, 그에 따른 별도의 대기 기간이 없습니다.</span>
              </div>
              <div>
                <span>고객이 신청서에 수업 희망 시간대를 체크하더라도, 선생님 측과의 수업 일정조율을 위해 운영매니저가 개별로 연락하여 일정을 조율할 수 있습니다.</span>
              </div>
              <div>
                <span>체험수업 일정변경은 최대 1회까지 가능하며, 그 이후 지정된 스케쥴에 수업진행이 불가할 경우 수업권은 소진된 것으로 간주합니다.</span>
              </div>
            </div>
          </div>
          <div className="two">
            ...
            <div>
              <span>체험수업 정책</span>
              <div>
                <span>한 선생님과의 체험수업은 최대 1회만 가능하며, 체험수업은 3명의 선생님과 최대 3번까지 가능합니다.</span>
              </div>
              <div>
                <span>한 선생님과 체험수업을 진행한 뒤, 다른 선생님으로 변경하게 되면 기존 선생님과의 수업 진행이 불가할 수 있습니다.</span>
              </div>
              <div>
                <span> 체험수업 진행을 위한 선생님을 지정할 수는 없으며, 프리미엄 선생님 배정을 희망할 경우 운영매니저에게 별도 알림이 필요합니다.</span>
              </div>
            </div>
          </div>
          <div className="two">
            ...
            <div>
              <span>체험수업 환불규정</span>
              <div>
                <span>체험수업 환불요청 시, 고객 측의 환불요청 시점에 따라 취소위약금이 차등 부과되며, 잔여금액은 아래 세부 조건에 따라 환불됩니다.</span>
              </div>
              <div>
                <span>수업일정 확정 이전: 수업료 100% 환불</span>
                <span>매칭 후 ~ 수업 이틀 전 18시 이전: 수업료 70% 환불</span>
                <span>6개월 등록권: 최대 6회 변경 가능</span>
                <span>수업 이틀 전 18시 이후 ~ 수업 하루 전 18시 이전: 수업료 50% 환불 수업 하루 전 18시 이후 ~ 수업 당일: 환불 불가</span>
              </div>
            </div>
          </div>
        </div>
...
export default CostPayPrepending;
