...
import { AlimeTeachertimeInfofullDate, timeDate } from "../../lib/api/timeDate";
      ...
      <div className="container">
        <div className="user_info-wrap">
          ...
          <div>
            ...
            <div>
              <span>수업 일정</span>
              <span>{AlimeTeachertimeInfofullDate(profileInfo?.scheduled_datetime)}</span>
            </div>
          </div>
        </div>
        <div className="user_info-wrap">
